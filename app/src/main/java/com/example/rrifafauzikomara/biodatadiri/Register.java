...
public class Register extends AppCompatActivity {
    ...
    private static final String REGISTER_URL = "http://falaharby.000webhostapp.com/restoran/User/register.php";
    String fullname, email, username, password, gender, address, telp;
